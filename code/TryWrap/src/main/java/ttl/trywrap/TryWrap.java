...
public class TryWrap<T> {
    ...
    public static <T> TryWrap<T> sleep(int amt, TimeUnit unit) {
       return TryWrap.ofRunnable(() -> unit.sleep(amt));
    }
    ...
    /**
     * Not strictly Monadic because we give up the
     * contained object.  Never say never?
     * @return
     */
    public T right() {
        if (right == null) {
