...
// * @author whynot
// */
//public class GoTillTest {
//    private static Logger logger = LoggerFactory.getLogger(GoTillTest.class);
//
...
//
//        List<TryWrap<Character>> firstChars = makeGoTill(firstCharsStream, tw -> tw.isLeft())
//                .collect(toList());
//
//        return firstChars;
//    }
